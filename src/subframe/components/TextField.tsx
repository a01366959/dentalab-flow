  ...
  function TextFieldRoot(
    ...
    return (
      ...
      >
        ...
        <div
          className={SubframeCore.twClassNames(
            "flex w-full flex-none items-center gap-1 rounded-md border border-solid border-neutral-border bg-default-background px-2 h-10 pl-4 pr-2 group-focus-within/be48ca43:border group-focus-within/be48ca43:border-solid group-focus-within/be48ca43:border-brand-primary",
            {
